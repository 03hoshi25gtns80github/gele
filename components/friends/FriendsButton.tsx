    ...
    <>
      <div
        ...
        className={`fixed bottom-20 right-4 md:bottom-12 md:right-12 text-white p-4 md:p-6 rounded-full cursor-pointer z-50 text-3xl md:text-4xl ${
          isExpanded ? "bg-green-400 dark:bg-emerald-600" : "bg-green-500 dark:bg-emerald-600"
        }`}
      >
        <FaUserFriends />
      </div>
      {isExpanded && (
        <aside
          ref={listRef}
          className="fixed top-16 md:top-24 bottom-0 right-0 bg-green-100 dark:bg-gray-700 transition-all duration-300 w-4/5 md:w-3/5 lg:w-1/3 h-3/4 md:h-screen z-50"
          onMouseEnter={handleMouseEnter}
